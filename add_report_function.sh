...
# Script para adicionar a função de relatório ao security_analyzer.sh
...
# Adicionar a função de relatório ao final do arquivo
cat >> "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh" << 'EOF'

# Função para gerar e exibir relatório HTML
show_html_report() {
...
# Modificar a função analyze_file para usar a nova função de relatório
sed -i '/^analyze_file() {/,/^}/ s/log_message "Arquivo analisado: $filepath (MD5: $md5_hash, SHA256: $sha256_hash)"/log_message "Arquivo analisado: $filepath (MD5: $md5_hash, SHA256: $sha256_hash)"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de Arquivo" "$filepath" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Modificar a função analyze_url para usar a nova função de relatório
sed -i '/^analyze_url() {/,/^}/ s/log_message "URL analisada: $url"/log_message "URL analisada: $url"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de URL" "$url" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Modificar a função analyze_domain para usar a nova função de relatório
sed -i '/^analyze_domain() {/,/^}/ s/log_message "Domínio analisado: $domain"/log_message "Domínio analisado: $domain"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de Domínio" "$domain" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Modificar a função analyze_hash para usar a nova função de relatório
sed -i '/^analyze_hash() {/,/^}/ s/log_message "Hash analisado: $hash ($hash_type)"/log_message "Hash analisado: $hash ($hash_type)"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de Hash" "$hash" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Modificar a função analyze_email para usar a nova função de relatório
sed -i '/^analyze_email() {/,/^}/ s/log_message "Email analisado: $email"/log_message "Email analisado: $email"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de Email" "$email" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Modificar a função analyze_email_header para usar a nova função de relatório
sed -i '/^analyze_email_header() {/,/^}/ s/log_message "Cabeçalho de email analisado: $header_file (Ameaças: $suspicious_count)"/log_message "Cabeçalho de email analisado: $header_file (Ameaças: $suspicious_count)"\n    \n    # Gerar e abrir relatório HTML\n    show_html_report "Análise de Cabeçalho de Email" "$header_file" "$LOG_FILE"/' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"

# Remover as chamadas para as funções antigas de relatório
sed -i 's/# Gerar e abrir relatório aprimorado.*$//' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"
...
# Remover as linhas que carregam os scripts de relatório
sed -i '/# Carregar funções de relatório em Markdown/d' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"
...
sed -i '/# Carregar funções de relatório aprimorado em Markdown/d' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"
...
sed -i '/# Carregar script de relatório simplificado/d' "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh"
