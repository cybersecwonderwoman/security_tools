...
# Script para criar um script separado para análise de IP

# Criar o script ip_analyzer_tool.sh
cat > "/home/anny-ribeiro/amazonQ/app/ip_analyzer_tool.sh" << 'EOF'
#!/bin/bash
...
chmod +x "/home/anny-ribeiro/amazonQ/app/ip_analyzer_tool.sh"

echo "Script ip_analyzer_tool.sh criado com sucesso!"
echo "Agora você pode analisar IPs usando: ./ip_analyzer_tool.sh <endereço_ip>"
