...
# Script para implementar relatórios em Markdown no security_analyzer.sh
...
cp "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh" "/home/anny-ribeiro/amazonQ/app/security_analyzer.sh.bak2"
echo "Backup criado em: /home/anny-ribeiro/amazonQ/app/security_analyzer.sh.bak2"

# Adicionar diretório de relatórios às configurações
...
# Criar função para gerar relatório em Markdown
cat > "/home/anny-ribeiro/amazonQ/app/markdown_report_functions.sh" << 'EOF'
#!/bin/bash
...
chmod +x "/home/anny-ribeiro/amazonQ/app/markdown_report_functions.sh"

# Modificar a função main para carregar as funções de relatório
sed -i '/^main() {/a \
